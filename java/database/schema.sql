...
DROP TABLE IF EXISTS specialty_topping, pizza_topping, topping, current_pizza, specialty_pizza, customer_order, customer, users;
...
CREATE TABLE pizza_topping (
    pizza_id int NOT NULL REFERENCES current_pizza(pizza_id),
